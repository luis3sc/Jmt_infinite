      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs md:text-sm font-black text-muted-foreground uppercase tracking-tight group-hover:scale-105 origin-left transition-transform">Pedidos</p>
          </div>
        </Link>
        ...
        <div className="space-y-4">
          {rejectedOrders > 0 ? (
            <div className="p-8 rounded-2xl bg-card border border-border flex flex-col sm:flex-row gap-6 items-start sm:items-center group hover:bg-muted/40 hover:border-border/80 transition-all duration-300 shadow-sm">
              ...
              <Link 
                href="/dashboard/orders"
                className="w-full sm:w-auto text-center px-8 py-4 rounded-2xl bg-primary text-white text-[10px] font-black uppercase tracking-widest hover:bg-primary/90 transition-all shadow-sm active:scale-95"
              >
                Corregir Ahora
              </Link>
            </div>
