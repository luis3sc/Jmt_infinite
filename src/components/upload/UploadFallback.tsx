   ...
   <div className="bg-card/40 backdrop-blur-xl border border-border/50 rounded-lg p-8 md:p-10 flex flex-col relative overflow-hidden shadow-2xl">
    ...
    <div className="flex flex-wrap gap-3 mt-auto relative z-10">
     <button 
      ...
      className="w-fit flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg bg-card/50 backdrop-blur-sm border border-border shadow-sm hover:bg-muted hover:border-primary/20 transition-all group text-sm font-semibold"
     >
      {copied ? (
