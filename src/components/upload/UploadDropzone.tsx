        ...
        <AnimatePresence mode="wait">
          {file ? (
            ...
            <motion.div 
              ...
              className="space-y-4 flex flex-col items-center relative z-10"
            >
              <div className={`w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center transition-all duration-500 ${isDragActive ? 'bg-primary text-white scale-110 shadow-2xl shadow-primary/30' : 'bg-primary/10 text-primary group-hover:scale-105 group-hover:bg-primary/20 shadow-inner'}`}>
